...
Napi::Value call_start_envelope_detection(const Napi::CallbackInfo &info) {
  Napi::Env env = info.Env();
  ...
  int res = pjw_call_start_envelope_detection(call_id, json.c_str());
...
Napi::Value call_stop_envelope_detection(const Napi::CallbackInfo &info) {
  Napi::Env env = info.Env();
  ...
  int res = pjw_call_stop_envelope_detection(call_id, json.c_str());
...
Napi::Object init(Napi::Env env, Napi::Object exports) {
  ...
  exports.Set("call_start_envelope_detection", Napi::Function::New(env, call_start_envelope_detection));
  ...
  exports.Set("call_stop_envelope_detection", Napi::Function::New(env, call_stop_envelope_detection));
